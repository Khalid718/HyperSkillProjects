...
# Creating a an array to store the animals by index.
animals = [camel, lion, deer, goose, bat, rabbit]
# Using a while loop to check user input.
while True:
    # Prompting user for input.
    user_input = input("Which habitat # do you need?")
    # If input does not equal "exit" then program will
    # print the animal that was read in by the user.
    if user_input != "exit":
        print(animals[int(user_input)])
    # If user input is equal to "exit" the program will
    # print a terminate message and break out of loop.
